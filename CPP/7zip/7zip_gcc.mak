...
MARCH=native
OPT_LVL=0
EXTRA_FLAGS=-mtune=$(MTUNE) -march=$(MARCH) -O$(OPT_LVL)
...
CFLAGS = $(MY_ARCH_2) $(LOCAL_FLAGS) $(CFLAGS_BASE2) $(CFLAGS_BASE) $(FLAGS_FLTO) $(CC_SHARED) $(EXTRA_FLAGS) -o $@
...
CXXFLAGS = $(MY_ARCH_2) $(LOCAL_FLAGS) $(CXXFLAGS_BASE2) $(CFLAGS_BASE) $(FLAGS_FLTO) $(CXXFLAGS_EXTRA) $(CC_SHARED) $(CXX_WARN_FLAGS) $(CXX_STD_FLAGS) $(EXTRA_FLAGS) -o $@
